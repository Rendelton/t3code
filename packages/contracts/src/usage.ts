 ...
 * `~/.grok/sessions/**\/updates.jsonl`, `~/.pi/agent/sessions/**\/*.jsonl`) rather than relying on T3 Code's own
 ...
 *
 * v5 adds `grok` and v6 adds `pi` to {@link UsageProviderKind}; v4 Claude/Codex buckets

 ...
 * session; those processes die with the registry scope.
 *
...
/**
 * pi is npm-managed, but its own `pi update` self-updater also covers native
 * installs and extension state — always route in-app updates through it.
 */
